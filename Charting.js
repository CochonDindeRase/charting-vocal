...
// Rendu des images
renderSectionImages(".dents1", "./wwwroot/maxillairevestibulaire.json", "maxV");
renderSectionImages(".dents2", "./wwwroot/mandibulevestibulaire.json", "mandV");
renderSectionImages(".dents3", "./wwwroot/maxillairepalatin.json", "maxP");
